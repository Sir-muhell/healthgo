      ...
      <div className="lg:grid grid-cols-5 gap-10 pt-10">
        <div className=" lg:col-span-2 ">
          <div className="privacy-box">
            <div className="relative">
              ...
              <img src={Logo} alt="" className="privacy-card-logo" />
            </div>
          </div>
        </div>
        ...
        <div className="col-span-3 lg:pt-0 pt-40">
          <div id="introduction">
            ...
            <div className="privacy-text">
              <p>
                ...
                infrastructure for the purchase of Telemedicine products and/or
                services.
              </p>
              <p>
                These General terms and conditions shall apply to users of the
                platform (website and mobile application) and shall govern your
                use of the platform and related services. By using our platform
                you accept these general terms and conditions in full. If you
                disagree with these general terms and conditions or any part of
          ...
          <div>
            ...
            <div className="privacy-text">
              <p>
                You may not register with our platform if you are under IB years
                of age (by using our platform or agreeing to these general terms
              ...
              <ul className="list-disc pl-10">
                ...
                <li>
                  Be responsible for any activity on our platform arising out of
                  any failure to keep your password confidential and that you
                  may be held liable for any lasses arising out of such a
                  failure.
                </li>
                <li>
                  Your account shall be used exclusively by you and you shall
                  not transfer your account to any third party. If you authorize
                  any third party to manage your account on your behalf this
                ...
                <li>
                  ...
                  paid far but not received and you have not breached these
          ...
          <div>
            ...
            <div className="privacy-text">
              <p>
                ...
                experience. However, our service offerings and their
              ...
              <ul className="list-disc pl-10">
                ...
                <li>
                  ...
                  (including particular functions, features, subscription plans
                  and promotional offerings).
                </li>
                <li>
                  The platform has no obligation to provide any specific content
                  through the HealthGO technologies
                </li>
                <li>
              ...
              <p>
                ...
                website to areas of our website and/or to functionality upon our
                website. We may far example suspend access to the website during
                server maintenance or when we update the website. You must not
          ...
          <div>
            ...
            <div className="privacy-text">
              ...
              <ul className="list-disc pl-10">
                ...
                <li>
                  Use our platform services by means of a web browser subject to
                ...
                <li>
                  ...
                  in the material you must not: Republish material from our
                  website (including republication on another website) Tell,
                  rent or sub-license material from our website; Show any
                  material from our website in public; Exploit material from our
                  website for a commercial purpose; or Redistribute material
                  from our website.
                </li>
                <li>
                  Except as expressly permitted by these general terms and
          ...
          <div>
            ...
            <div className="privacy-text">
              <ul className="list-disc pl-10">
                <li>
                  The information on this website [or mobile application] is not
                  intended or implied to be a substitute for professional
                  medical advice, diagnosis or treatment. All content, including
                  text, graphics, images and information, contained on or
                  available through this website is for general information
                  purposes only. All information on this site is well researched
                  and reviewed and is provided in good faith. HealthGo makes no
                  representation or warranty of any kind, express or implied,
                  and assumes no responsibility for the accuracy, validity,
                  reliability, availability or completeness of any information
                  contained on or available through this website, and such
                ...
                <li>
                  ...
                  provided on the site [or mobile application]. Your use of the
                  site [or our mobile application] and your reliance on any
                  information thereof is solely at your own risk.
                </li>
                <li>
                  ...
                  read on or accessed through this website.
                </li>
                <li>
                  ...
                  web site. HealthGo is neither responsible nor liable for any
                  advice, course of treatment, diagnosis or any other
                  information, services or products that you obtain through this
                  website.
                </li>
                <li>
                  Medical and health practitioners affiliated with HealthGo are
                  duly licensed and registered professionals. Health
                  ...
                  extent, HealthGo is not responsible for the services provided
                  by the said health practitioners.
                </li>
                <li>
                  HealthGo shall not bear any liability for hyperlinks to
                  websites or services of third parties included on this website
                  [or our mobile application]. From our service, you can visit
                  other websites by following hyperlinks to such external sites.
                  While we strive to provide only quality and relevant links to
                ...
                <li>
                  In the event that any injury or loss is occasioned by the use
                  of this website, the user shall immediately notify us and give
                  particulars of such injury or loss.
                </li>
              </ul>
              <p>
