          ...
          <div className="lg:grid grid-cols-7">
            <div className="col-span-4 lg:pl-20">
              ...
              <div className="pt-10 icons">
                <a href="https://www.linkedin.com/company/healthgohq/"><img src={Icon6} alt="" /></a>
                <a href="https://www.instagram.com/healthgohq/"> <img src={Icon5} alt="" /></a>
                <a href="https://twitter.com/healthgoHQ"><img src={Icon3} alt="" /></a>
                {/* <a href="https://"> <img src={Icon1} alt="" /></a> */}
                <a href="https://t.me/HealthgoHQ"><img src={Icon2} alt="" /></a>
                <a href="https://medium.com/@HealthGO_HQ"><img src={Icon4} alt="" /></a>
              </div>
              <button class="mt-8 bg-secondary border border-primary hover:bg-primary hover:text-white text-primary font-bold py-3 px-6 rounded inline-flex items-center">
